...
LRESULT CALLBACK VolSelectProc(HWND dlg, UINT msg, WPARAM wp, LPARAM lp)
{
	...
	switch(msg) {
		case WM_INITDIALOG:
			...
			//
			if(dfDisk != (enum DiskFormat)ADF){				// Get size of original compressed disk image.
				comp_size = 0;
